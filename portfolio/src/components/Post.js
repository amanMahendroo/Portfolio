    ...
    return (
        <main className="bg-green-100 min-h-screen p-12">
            <section className="container mx-auto">
                ...
                <h2 className="text-l text-gray-600 flex justify-center mb-12">Welcome to my page of blogposts</h2>
                        ...
                        <article>
                            ...
                            bg-white border-l-8 border-green-400" key={index}>
                                ...
                                <span className="block relative h-full flex justify-end items-end pr-4 pd-4">
                                    ...
                                    bg-red-700 text-red-100 bg-opacity-75 rounded">{post.title}</h3>
                                </span>
                            </span>
                            </Link>
                        </article>
